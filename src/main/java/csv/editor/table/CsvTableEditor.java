...
public abstract class CsvTableEditor implements FileEditor, FileEditorLocation {
    ...
    public void saveChanges(final String content) {
        ...
        ApplicationManager.getApplication().invokeLater(() -> {
            if (!this.document.isWritable() && ReadonlyStatusHandler.getInstance(this.project)
                    .ensureFilesWritable(this.file).hasReadonlyFiles()) {
                return;
            }
    ...
    public void setState(@NotNull FileEditorState fileEditorState) {
        CsvTableEditorState tableEditorState = fileEditorState instanceof CsvTableEditorState ?
                (CsvTableEditorState) fileEditorState : new CsvTableEditorState();
    ...
    public boolean isModified() {
        return this.dataManagement != null && initialState != null &&
                !this.dataManagement.equalsCurrentState(initialState);
    }
    ...
    public StructureViewBuilder getStructureViewBuilder() {
        return file != null && file.isValid() ? StructureViewBuilder.PROVIDER
                .getStructureViewBuilder(file.getFileType(), file, this.project) : null;
    }
